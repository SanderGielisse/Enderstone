...
public abstract class Packet {
	...
	public void writeDataWatcher(DataWatcher watcher, ByteBuf buf) {
		for (Entry<Integer, Object> watch : watcher.watched.entrySet()) {
	...
	public DataWatcher readDataWatcher(ByteBuf buf) {
	...
	public int getDataWatcherSize(DataWatcher watcher) throws UnsupportedEncodingException {
		int total = 0;
		for (Entry<Integer, Object> watch : watcher.watched.entrySet()) {
			if (watch.getValue() instanceof Byte) {
				// byte, index
