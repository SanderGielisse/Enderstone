...
public abstract class ChunkGenerator {
     ...
     * generator
     */
    public BlockId[][] generateExtBlockSections(EnderWorld world, Random random, int x, int z, BiomeGrid biomes) {
     ...
     * generator
     */
    public BlockId[][] generateBlockSections(EnderWorld world, Random random, int x, int z, BiomeGrid biomes) {
