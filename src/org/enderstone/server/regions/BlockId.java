...
public enum BlockId {
	...
	WEB(30, true, true), //fix fall speed
	LONG_GRASS(31, true, true),
	DEAD_BUSH(32, true, true),
	PISTON_BASE(33, true),
	PISTON_EXTENSION(34, true),
	WOOL(35, true),
	PISTON_MOVING_PIECE(36, true),
	YELLOW_FLOWER(37, true, true),
	...
	WALL_SIGN(68, true, true),
	LEVER(69, true),
	STONE_PLATE(70, true, true),
	IRON_DOOR_BLOCK(71, true),
	WOOD_PLATE(72, true, true),
	REDSTONE_ORE(73, true),
	GLOWING_REDSTONE_ORE(74, true),
	REDSTONE_TORCH_OFF(75, true, true),
	REDSTONE_TORCH_ON(76, true, true),
	BUTTON(77, true, true),
	SNOW(78, true),
	ICE(79, true),
	SNOW_BLOCK(80, true),
	...
	CAKE_BLOCK(92, true),
	DIODE_BLOCK_OFF(93, true, true),
	DIODE_BLOCK_ON(94, true, true),
	...
	STAINED_GLASS(160, true),
	ACACIA_LEAVES(161, true),
	ACACIA_WOOD(162, true),
	ACACIA_WOOD_STAIRS(163, true),
	DARK_OAK_WOOD_STAIRS(164, true),
	SLIME_BLOCK(165, true),
	BARRIER(166, true),
	IRON_TRAPDOOR(167, true),
	PRISMARINE(168, true),
	SEA_LANTERN(169, true),
	HAY_BLOCK(170, true),
	CARPET(171, true),
	HARD_CLAY(172, true),
	COAL_BLOCK(173, true),
	PACKED_ICE(174, true),
	FLOWER(175, true),
	BANNER_STANDING(176, true),
	BANNER_HANGING(177, true),
	INVERTED_DAYLIGHT_SENSOR(178, true),
	RED_SANDSTONE(179, true),
	RED_SANDSTONE_STAIRS(180, true),
	RED_SANDSTONE_DOUBLE_SLAB(181, true),
	RED_SANDSTONE_SLAB(182, true),
	SPRUCE_FENCE_GATE(183, true),
	BIRCH_FENCE_GATE(184, true),
	JUNGLE_FENCE_GATE(185, true),
	DARK_OAK_FENCE_GATE(186, true),
	ACACIA_FENCE_GATE(187, true),
	SPRUCE_FENCE(188, true),
	BIRCH_FENCE(189, true),
	JUNGLE_FENCE(190, true),
	DARK_OAK_FENCE(191, true),
	ACACIA_FENCE(192, true),
	SPRUCE_DOOR_BLOCK(193, true),
	BIRCH_DOOR_BLOCK(194, true),
	JUNGLE_DOOR_BLOCK(195, true),
	ACACIA_DOOR_BLOCK(196, true),
	DARK_OAK_DOOR_BLOCK(197, true),
	// ----- Item Separator -----
	...
	PRISMARINE_SHARD(409, false),
	PRISMARINE_CRYSTALS(410, false),
	RAW_RABBIT(411, false),
	COOKED_RABBIT(412, false),
	RABBIT_STEW(413, false),
	RABBIT_FOOT(414, false),
	RABBIT_HIDE(415, false),
	ARMOR_STAND(416, false),
	IRON_BARDING(417, false),
	GOLD_BARDING(418, false),
	DIAMOND_BARDING(419, false),
	LEASH(420, false),
	NAME_TAG(421, false),
	MINECART_COMMAND_BLOCK(422, false),
	RAW_MUTTON(423, false),
	COOKED_MUTTON(424, false),
	BANNER(425, false),
	SPRUCE_DOOR(427, false),
	BIRCH_DOOR(428, false),
	JUNGLE_DOOR(429, false),
	ACACIA_DOOR(430, false),
	DARK_OAK_DOOR(431, false),
