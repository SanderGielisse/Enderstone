...
public class PacketOutEntityEquipment extends Packet {
	...
	public PacketOutEntityEquipment(int entityId, short slot, ItemStack stack) {
	...
	public int getSize() throws IOException {
		return getVarIntSize(entityId) + getShortSize() + getItemStackSize(stack) + getVarIntSize(getId());
	}
